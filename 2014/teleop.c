...
#pragma config(Motor,  mtr_S1_C1_1,     M_DRIVE_FL,    tmotorTetrix, openLoop, reversed, encoder)
#pragma config(Motor,  mtr_S1_C1_2,     M_DRIVE_BL,    tmotorTetrix, openLoop, reversed, encoder)
