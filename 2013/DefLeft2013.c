...
task main()
{
  ...
  servo[SV_LightSensor]=C_SVLIGHTSENSORIN;
  	...
  	autoDrive(7,45.0); wait1Msec(200);//starting on right
  	autoDrive(1,10.0);  wait1Msec(200);
  	autoDrive(7,10.0); wait1Msec(200);//starting on right
  	autoDrive(1,25.0);  wait1Msec(200);
