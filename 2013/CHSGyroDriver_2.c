...
task GyroDeviceDriver()
{
	...
	float fVelocityFactor    = -0.00307*0.71;		// A constant used in integrating the readings from the sensor
	...
	kNoiseEliminate = abs(fGyroBias)/10;
