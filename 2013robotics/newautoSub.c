...
{
		motor[M_DriveFL] = (floor(1000*powerfactor)*(xpow + ypow + rot))/1000; //xpow + rot; xpow + ypow + rot;
	  motor[M_DriveBR] = (floor(1000*powerfactor)*(xpow + ypow - rot))/1000; //xpow - rot;
		motor[M_DriveFR] = (floor(1000*powerfactor)*(xpow - ypow + rot))/1000;
	  motor[M_DriveBL] = (floor(1000*powerfactor)*(xpow - ypow - rot))/1000;
}
...
{
		motor[M_DriveFL] = (floor(1000*powerfactor)*rot)/1000;
	  motor[M_DriveBR] = (floor(1000*powerfactor)*(-rot))/1000;
		motor[M_DriveFR] = (floor(1000*powerfactor)*rot)/1000;
	  motor[M_DriveBL] = (floor(1000*powerfactor)*(-rot))/1000;
}
