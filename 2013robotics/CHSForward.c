...
task main()
{
  ...
  switch(leftright){
  	...
  	autoDrive(5,34.0); wait1Msec(200); //starting on left
  	autoDrive(4,4.0);  wait1Msec(200);
  	autoRotate(90.0); //45 degrees clockwise should be in IR sensor position
  	 	//IR read
